...
const Demandes = () => {
    ...
    const HandleClick = (demande) => {
        Alert.alert("Downloading ..." + demande.file_path)
    }
    return (
                                ...
                                <View style={{ width: '30%' }}>
                                    <Text style={styles.table_data}>
                                        {demande.etat == 0 ? (
                                            ...
                                            <TouchableOpacity style={{ padding: 5, backgroundColor: '#192944' }} onPress={() => HandleClick(demande)} ><Text style={{ color: 'white' }}>Télécharger</Text></TouchableOpacity>
                                        )}
                                    </Text>
                                </View>
                            </View>
